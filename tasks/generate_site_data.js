...
const tags = Object.entries(tagsUsage)
  .sort((a, b) => (a[1] > b[1] ? -1 : (a[1] < b[1] ? 1 : 0)))

const descriptionLengths = donatees
  .reduce((res, d) => res.concat([[d.id, d.description.length]]), [])
  .sort((a, b) => (a[1] > b[1] ? -1 : (a[1] < b[1] ? 1 : 0)))
const averageDescriptionLength = Math.round(descriptionLengths.reduce((res, d) => res + d[1], 0) / descriptionLengths.length)
